...
public class VentanaPrincipal extends JFrame implements ActionListener
	{
	   ...
	   private JMenu menuArchivo,menuEdicion,menuAcercaDe, subMenuGirar, menuOpciones;
	    ...
	    private JLabel labelArchivoSeleccionado, labelEdicionSeleccionado, 
                    labelOpcionesCheckSeleccionadas,labelOpcionesRadioSeleccionadas;
		...
		informacionAplicacion+="componentes de menu Java Swing.\n\n";
		...
		public void actionPerformed(ActionEvent evento) {
			...
			if (evento.getSource()==itemEmergente1) {
				JOptionPane.showMessageDialog(null, "Presion� la opci�n emergente 1");
			}
			
			if (evento.getSource()==itemEmergente2) {
				JOptionPane.showMessageDialog(null, "Presion� la opci�n emergente 2");
			}
