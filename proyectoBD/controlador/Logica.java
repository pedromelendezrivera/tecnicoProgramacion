...
public class Logica {
	...
	public void validarRegistro(PersonaVo miPersona) {
		...
		if (miPersona.getIdPersona() > 99999) {
	...
	public PersonaVo validarConsulta(String codigoPersona) {
		...
		try {
			...
			if (codigo > 99999) {
				...
				JOptionPane.showMessageDialog(null,"El documento de la persona debe ser mas de 5 digitos","Advertencia",JOptionPane.WARNING_MESSAGE);
